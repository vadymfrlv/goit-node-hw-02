...
- Пройшовши по посиланню в отриманому листі, в перший раз, користувач отримає відповідь зі статусом
  200(Verification successful), що має на увазі успішну верифікацію email.
- Пройшовши по посиланню повторно користувач повинен отримати помилку(User not found).
...
### Повторна відправка email користувачу з посиланням для верифікації email @ POST /api/users/verify
